...
export default new MedoneEventBuilder()
  ...
  .setRun(async (client, message) => {
     ...
     */
    const command =
      client.medone.commands.nonprefixcommands[commandInput] ||
      client.medone.commands.nonprefixcommands[
        client.medone.commands.nonprefixcommandsaliases[commandInput]
      ];
